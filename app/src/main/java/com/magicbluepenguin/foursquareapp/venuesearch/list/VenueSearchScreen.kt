...
import com.magicbluepenguin.foursquareapp.venuesearch.list.DataRetrieved
import com.magicbluepenguin.foursquareapp.venuesearch.list.EmptyResult
import com.magicbluepenguin.foursquareapp.venuesearch.list.Loading
import com.magicbluepenguin.foursquareapp.venuesearch.list.VenueSearchViewModel
import com.magicbluepenguin.foursquareapp.venuesearch.views.EmptyResultMessage
import com.magicbluepenguin.foursquareapp.venuesearch.views.FullScreenProgress
        ...
        when (val state = venueListState) {
            ...
            is DataRetrieved -> {
                val errorMessage = when (state.errorCause) {
                    Network -> stringResource(R.string.venue_search_internet_connection_error)
